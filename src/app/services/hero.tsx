  ...
  return (
    <header className="clip-trapezoid bg-claybrown px-4 pt-28 pb-40 shadow-sm sm:px-8">
      <div className="relative mx-auto w-full max-w-(--breakpoint-2xl) lg:flex">
        ...
        <h1 className="text-ivory text-shadow-espresso hidden basis-1/3 items-center justify-center text-center font-extrabold tracking-widest uppercase lg:flex">
          Services
        </h1>
      </div>
    </header>
