...
export function AboutHeader() {
  return (
    <header className="clip-trapezoid bg-terracotta relative gap-4 p-8 pb-32 shadow-sm lg:grid lg:grid-cols-2">
      <div className="relative flex h-[500px] md:justify-center md:gap-8 lg:grid lg:grid-cols-3">
        <div className="absolute z-10 h-[500px] w-[200px] overflow-hidden rounded-t-[100px] rounded-b-3xl shadow-sm md:relative md:z-auto">
          <Image
            src={"/about1.jpg"}
            alt="Hero Image"
            fill
        ...
        <div className="absolute left-1/2 z-20 h-[500px] w-[200px] -translate-x-1/2 overflow-hidden rounded-t-[100px] rounded-b-3xl shadow-sm md:relative md:left-0 md:z-auto md:-translate-x-0">
          <Image
            src={"/about2.jpg"}
            alt="Hero Image"
            fill
        ...
        <h1 className="text-ivory absolute top-1/2 left-1/2 z-40 flex w-full -translate-x-1/2 -translate-y-1/2 justify-center px-4 font-extrabold tracking-wider uppercase lg:hidden">
          <span className="bg-claybrown/50 rounded-xs p-8">About Us</span>
        </h1>
      </div>
