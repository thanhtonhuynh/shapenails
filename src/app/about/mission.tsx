...
export function Mission() {
  return (
    <section className="flex flex-col gap-8 sm:flex-row-reverse sm:gap-0">
      <div className="border-deepespresso border-dashed px-4 sm:basis-1/3 sm:border-l sm:px-8">
